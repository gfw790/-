...
$canAccessSafetyManual = $canAccessEmploymentRules;
  ...
  <div class="shell">
    <div class="topbar">
      ...
      <div class="desktop-action-cloud">
          <a class="btn-secondary" href="msds_list.php">MSDS</a>
          <?php if ($isGasTeam): ?>
        ...
        <?php endif; ?>
        <?php if ($canAccessSafetyManual): ?>
          <a class="btn-secondary btn-employment-rules" href="/safety_manual/index.php">중대재해 매뉴얼</a>
        <?php endif; ?>
