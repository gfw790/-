        ...
        (function () {
            ...
            function buildPrintPreview() {
                ...
                function startChartPage() {
                    ...
                    var chartScale = 1;
                    if (availableHeight > 0 && chartNaturalHeight > availableHeight - 8) {
                        chartScale = (availableHeight - 8) / chartNaturalHeight;
                    }
                    if (chartScale < 1) {
                        chartClone.style.transform = 'scale(' + chartScale + ')';
                        chartClone.style.transformOrigin = 'top left';
                    }
                    chartDocument.style.height = Math.ceil(chartNaturalHeight * chartScale) + 'px';
