...
function safety_manual_build_pdf_html(string $title, string $contentHtml, ?array $current = null): string
{
    ...
    return '<!DOCTYPE html>'
        ...
        . '.document h2 { margin: 0 0 5mm; padding: 3mm 4mm; border: 0.5mm solid #b7cee8; background: #dcecff; font-size: 16pt; color: #17315c; text-align: left; page-break-after: avoid; }'
