...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .cards { display: grid; grid-template-columns: minmax(0, 1fr) minmax(0, 1fr); gap: 8mm; }
        .card { border: 1px solid #222; padding: 6mm; background: #fff; }
        .card h2 { margin: 0 0 5mm; color: #17477f; font-size: 18px; }
        ...
        input, select, textarea { width: 100%; border: 1px solid #9aaabd; border-radius: 5px; padding: 8px; font: inherit; }
        textarea { min-height: 110px; resize: vertical; }
        .notice { margin: 0 0 10px; padding: 9px 11px; background: #edf7ee; color: #165c2b; border: 1px solid #b7dfbf; }
        .error { margin: 0 0 10px; padding: 9px 11px; background: #fff1f1; color: #8c1d1d; border: 1px solid #f0b8b8; }
        ...
        .actions { display: flex; justify-content: flex-end; gap: 8px; margin-top: 5mm; }
        @media (max-width: 800px) { .paper { width: 100%; min-height: 100vh; } .toolbar { margin: 10px; } .cards { grid-template-columns: 1fr; } }
        @media print { body { background: #fff; } .toolbar, .actions, .notice, .error, .editor-card { display: none; } .paper { margin: 0; border: 1px solid #111; } .cards { display: block; } .history-card { margin-top: 10mm; } }
    </style>
</head>
<body>
    <div class="toolbar">
