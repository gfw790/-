    ...
    <main class="layout">
        ...
        <section class="main">
            <article class="content-card">
                <div class="manual-policy-link-wrap">
                    <a class="manual-policy-link" href="management_policy.php">안전보건 경영방침 만들기</a>
                </div>
                <?php if ($current): ?>
    ...
    <script>
        (function () {
            ...
            function prepareSafetyManualSectionAnchor() {
                if (!documentRoot || document.getElementById('safety-goal-management-policy')) {
                    return;
                }
