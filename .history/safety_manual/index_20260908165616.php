    ...
    <script>
        (function () {
            ...
            function updateChartConnectors(root) {
                ...
                // 녹색 섹션: 2·4번 버튼 우측 중심 -> 우측 오브젝트(점검 내용)의 우측 중심 (녹색 선분)
                ...
                var greenTarget = root.querySelector('#chart-green-desc');
                if (greenRow && greenSvg && greenTarget) {
                    var gRowRect = greenRow.getBoundingClientRect();
                    var gTargetRect = greenTarget.getBoundingClientRect();
                    ...
                    var gTargetX = gTargetRect.right - gRowRect.left;
                    var gTargetY = gTargetRect.top + gTargetRect.height / 2 - gRowRect.top;
                    // 세로 간선은 배지/화살표 구간(아이템 열과 우측 오브젝트 사이) 중간에 배치
                    var gTrunkX = gTargetRect.left - gRowRect.left - 12;

                    if (gSources.g2) {
                        root.querySelector('#chart-line-g2').setAttribute('d', 'M ' + gSources.g2.x + ' ' + gSources.g2.y + ' H ' + gTrunkX + ' V ' + gTargetY + ' H ' + gTargetX);
                    }
                    if (gSources.g4) {
                        root.querySelector('#chart-line-g4').setAttribute('d', 'M ' + gSources.g4.x + ' ' + gSources.g4.y + ' H ' + gTrunkX);
                    }
                }
            }
            ...
            function buildPrintPreview() {
                ...
                function startChartPage() {
                    ...
                    chartDocument.style.height = Math.ceil(chartClone.getBoundingClientRect().height + 12) + 'px';
