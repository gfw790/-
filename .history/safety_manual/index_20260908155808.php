        ...
        (function () {
            ...
            function updateChartConnectors(root) {
                ...
                [3, 7, 8, 9].forEach(function (number) {
                    ...
                    var path = root.querySelector('#chart-line-' + number);
                    if (!source || !path) return;

                    var sourceRect = source.getBoundingClientRect();
                    var startX = sourceRect.right - rowRect.left;
                    var startY = sourceRect.top + sourceRect.height / 2 - rowRect.top;
                    var endX = targetRect.left - rowRect.left;
                    var endY = targetRect.top + targetRect.height / 2 - rowRect.top;
                    var bendX = Math.max(startX + 4, endX - 8);
