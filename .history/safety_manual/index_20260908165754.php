        ...
        (function () {
            ...
            function updateChartConnectors(root) {
                ...
                if (greenRow && greenSvg && greenBadge) {
                    ...
                    if (gSources.g2) {
                        root.querySelector('#chart-line-g2').setAttribute('d', 'M ' + gSources.g2.x + ' ' + gSources.g2.y + ' H ' + gTrunkX);
                    }
                    if (gSources.g4) {
                        root.querySelector('#chart-line-g4').setAttribute('d', 'M ' + gSources.g4.x + ' ' + gSources.g4.y + ' H ' + gTrunkX + ' M ' + gTrunkX + ' ' + gTargetY + ' H ' + gTargetX);
                    }
                }
            }
