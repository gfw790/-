...
function safety_manual_build_pdf_html(string $title, string $contentHtml, ?array $current = null): string
{
    ...
    return '<!DOCTYPE html>'
        ...
        . 'body { margin: 0; color: #1f2937; font-family: dejavusans, sans-serif; font-size: 11pt; line-height: 1.55; }'
        ...
        . '.document p { margin: 0 0 2mm; line-height: 1.55; }'
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .print-preview-page .document p,
        .print-preview-page .document li {
            line-height: 1.55;
            margin-top: 6px;
            margin-bottom: 6px;
        }

        .print-preview-page .document h2,
        .print-preview-page .document h3 {
            line-height: 1.3;
        }
