...
if($values['r9']['plan']!=='100'||$planBreakdown['r9']['mode']!=='average')throw new Exception('CSM average mismatch');
echo 'PASS CSM quarterly average = 100; modal mode = average'.PHP_EOL;
if($values['r11']['plan']!=='20'||$planBreakdown['r11']['mode']!=='average')throw new Exception('Average mismatch');
