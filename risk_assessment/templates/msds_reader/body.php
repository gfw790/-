  ...
  <?php foreach ($mobileGlossary as $index => $entry): ?>
    <div class="mobile-glossary-sheet" id="<?= h('mobile-glossary-entry-' . $index) ?>" aria-hidden="true">
      <a class="mobile-glossary-sheet-backdrop mobile-glossary-sheet-close" href="#" onclick="return window.__closeMobileGlossarySheet ? window.__closeMobileGlossarySheet(event) : true;" aria-label="닫기"></a>
      <div class="mobile-glossary-sheet-dialog" role="dialog" aria-modal="true" aria-labelledby="<?= h('mobile-glossary-sheet-title-' . $index) ?>">
        ...
        <div class="mobile-glossary-actions">
          <a class="btn btn-ghost mobile-glossary-sheet-close" href="#" onclick="return window.__closeMobileGlossarySheet ? window.__closeMobileGlossarySheet(event) : true;">닫기</a>
        </div>
      </div>
    </div>
  <?php endforeach; ?>
