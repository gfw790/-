...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .org-vert { width:2px; height:22px; background:var(--border2); flex-shrink:0; }
  ...
  .org-teams-row { display:flex; flex-wrap:wrap; gap:12px; justify-content:center; align-items:flex-start; }
  ...
  #org-phone-tip .tip-name { color:var(--text-lo); font-size:11px; margin-bottom:3px; }
  #org-phone-tip .tip-phone { color:var(--text-hi); font-weight:700; font-size:15px; }
</style>
</head>
<body>
  <div class="shell">
